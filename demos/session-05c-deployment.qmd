...
| # | Topic | | # | Topic |
|---|---|---|---|---|
| 1 | [Demo or deployment?](#demo-or-deployment) | | 8 | [Common widgets](#common-widgets) |
| 2 | [Environment setup](#environment-setup) | | 9 | [Layout and display](#layout-and-display) |
| 3 | [Project layout](#project-layout) | | 10 | [The three rules](#the-three-rules-that-fix-most-streamlit-bugs) |
| 4 | [App 1 — `train.py`](#app-1--trainpy) | | 11 | [Where to look things up](#where-to-look-things-up) |
| 5 | [App 1 — `app.py`](#app-1--apppy) | | 12 | [App 2 — Loan approval](#app-2--loan-approval) |
| 6 | [Running it](#running-it) | | 13 | [App 3 — Diabetes screening](#app-3--diabetes-screening) |
| 7 | [The pattern, extracted](#the-pattern-extracted) | | 14 | [App 4 — Salary prediction](#app-4--salary-prediction) |
...
**Everything here runs in the course's `demo` environment.**
...
|---|---|---|
| **[Loan approval](#app-2--loan-approval)** | Binary classification | **Categorical inputs, and a `ColumnTransformer`** |
| **[Diabetes screening](#app-3--diabetes-screening)** | Binary, **imbalanced** | **A user-adjustable threshold** |
| **[Salary prediction](#app-4--salary-prediction)** | Regression | **A number, with an honest error range** |
...
**[Session 3](session-03-eda-preprocessing.qmd#the-sequence)'s sequence, and it finds things.**
...
>
> **In most jurisdictions an automated credit decision on that basis is illegal**, and a "borderline → human reviewer" rule is the *minimum* safeguard, not a solution.

---

# App 3 — Diabetes screening
...
> **The threshold slider is the point of this app.** **[Session 5B](session-05b-classification.qmd) argued that 0.5 is only a default; here the user can move it and watch the trade-off happen.**
>
> **And notice the caption leads with recall and precision, not accuracy.** **"88.5% accurate" would be true and misleading.**

---

# App 4 — Salary prediction
...
**[Session 3](session-03-eda-preprocessing.qmd#when-not-to-remove-duplicates) warned about exactly this case. Here is the measurement.**
...
> **The smaller model is also the more accurate one** — the depth limit is regularisation, doing its job.
>
...
| **Hugging Face Spaces** | Free, and the natural home for ML demos |
...
**Task 1 — Verify your environment.** Activate `demo`, print the versions of scikit-learn, streamlit, pandas and joblib, and run `streamlit hello`. **Report what you saw.**
