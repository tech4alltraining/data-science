...
| # | Topic |
|---|---|
| 1 | [What classification is](#what-classification-is) |
| 2 | [Use case 1 — Loan approval](#use-case-1--loan-approval) |
| 3 | [TP, TN, FP, FN — the four outcomes](#tp-tn-fp-fn--the-four-outcomes) |
| 4 | [The evaluation metrics](#the-evaluation-metrics) |
| 5 | [The six algorithms](#the-six-algorithms) |
| 6 | [Pipelines](#pipelines) |
| 7 | [Use case 2 — Imbalanced data](#use-case-2--imbalanced-data) |
| 8 | [Use case 3 — More than two classes](#use-case-3--more-than-two-classes) |
| | *Deploying these models is [Session 5C](session-05c-deployment.qmd)* |
...
# Use case 3 — More than two classes
